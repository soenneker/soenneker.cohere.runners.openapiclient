...
using Soenneker.Cohere.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Cohere.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Cohere:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/cohere-ai/cohere-developer-experience/refs/heads/main/cohere-openapi.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "CohereOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
